...
pickupBtn.Position = UDim2.new(0, 10, 0, 265)
...
hopBtn.Position = UDim2.new(0, 10, 0, 300)
...
switchBtn.Position = UDim2.new(0, 10, 0, 338)
...
local targetObj = nil   -- HumanoidRootPart หรือ player
local CAM_HEIGHT = 20
...
RunService:BindToRenderStep("FinderCamLock", Enum.RenderPriority.Camera.Value + 1, function()
    ...
    local hrp
    if currentMode == "fruit" and targetObj and targetObj.Character then
